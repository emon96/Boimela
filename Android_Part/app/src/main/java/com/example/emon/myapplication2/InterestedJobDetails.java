...
public class InterestedJobDetails extends AppCompatActivity {
    ...
    int selected;
    String interest,jobname=null;
    private Button button;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_interested_job_details);
       ...
       // jobname=getIntent().getStringExtra("jobcategory");
            ...
            databaseReference=FirebaseDatabase.getInstance().getReference().child("All Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Interested").child(friend_id);
